...
public class ProviderAdapter extends ArrayAdapter<Provider> {
    ...
    public ProviderAdapter(Activity context, ArrayList<Provider> providers,int color) {
    ...
    public View getView(int position,  View convertView,  ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.list_providers_template, parent, false);
        }

        // Get the {@link AndroidFlavor} object located at this position in the list
        Provider currentword = getItem(position);
